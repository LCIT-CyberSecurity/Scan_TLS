...
def build_html_report_from_model(model: ReportModel):
    ...
    parts = [
        ...
        '  <header class="app-shell no-print"><div class="brand-block"><div class="brand-mark" aria-hidden="true">TS</div><div><strong>TLS Scan</strong><span>Security Report</span></div></div><nav aria-label="Report sections"><a href="#overview">Overview</a><a href="#findings">Findings</a><a href="#endpoints">Endpoints</a><a href="#certificates">Certificates</a><a href="#compliance">Compliance</a><a href="#pqc">PQC</a></nav><button class="button button-primary" type="button" id="printReport">Print / Save as PDF</button></header>',
