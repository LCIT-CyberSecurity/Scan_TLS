...
def build_html_report_from_model(model: ReportModel):
    ...
    parts = [
        ...
        '    <section class="panel" id="trust"><div class="section-heading"><div><p class="eyebrow">Chain Validation</p><h2>Certificate Trust</h2></div><span class="section-count">TLS Scan Public Web PKI - Mozilla-derived public trust store</span></div><div id="certificateTrust"></div></section>',
